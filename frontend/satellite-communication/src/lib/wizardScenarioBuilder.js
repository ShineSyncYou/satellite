...
export function buildSampleConfigPreview(draft) {
  ...
  return {
    ...
    sat_antenna_angle: roundTo(draft.communicationParams?.satAntennaAngleDeg ?? 24, 3),
...
export function buildWizardManifest(draft) {
  ...
  return {
    ...
    communicationParams: {
      satAntennaAngleDeg: roundTo(draft.communicationParams?.satAntennaAngleDeg ?? 24, 3),
